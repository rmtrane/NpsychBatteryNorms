...
For transparency and completeness, we present tables with the data used for standardization, including tables showing how age and education levels are grouped when applicable.
