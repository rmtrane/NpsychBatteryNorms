#' Means and SDs for calculating z-scores (per 2024)
#'
#' @format A list of tibbles similar to `normative_zscores_2020`, but created
#'   from the June 2024 data freeze.
